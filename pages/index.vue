<template>
  <div class="">
    <div class="jumbotron p-4 p-md-5 text-white rounded bg-dark parallax" >
      <div class="col-md-7 px-0 container">
  ...
  <section class="container">
  	<!-- <div class="jumbotron jumbotron-fluid mb-3 pt-0 pb-0 bg-lightblue position-relative">
  		<div class="pl-4 pr-0 h-100 tofront">
  			<div class="row justify-content-between">
  				...
  				<div class="col-md-6 d-none d-md-block pr-0" style="background-size:cover;background-image:url(/img/demo/home.jpg);">	</div>
  			</div>
  		</div>
  	</div> -->
    ...
    <div class="container pt-4 pb-4">
    	<div class="row">
            ...
            <div style="background-image: url(/img/demo/1.jpg); height: 150px;    background-size: cover;    background-repeat: no-repeat;"></div>
    	...
    	<div class="row justify-content-between">
    		<div class="col-md-8">
    			...
    			<div class="mb-3 d-flex justify-content-between">
    				...
    				<img height="120" src="/img/demo/blog8.jpg">
    			</div>
    			<div class="mb-3 d-flex justify-content-between">
    				<div class="pr-3">
    					<h2 class="mb-1 h4 font-weight-bold">
    				...
    				<img height="120" src="/img/demo/1.jpg">
    			</div>
    			<div class="mb-3 d-flex justify-content-between">
    				<div class="pr-3">
    					<h2 class="mb-1 h4 font-weight-bold">
    				...
    				<img height="120" src="/img/demo/5.jpg">
    			</div>
    		</div>
...
.parallax {
  /* The image used */
  background-image: url("/img/demo/sky2.jpg");
